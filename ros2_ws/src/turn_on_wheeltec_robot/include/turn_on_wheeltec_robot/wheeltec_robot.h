...
class turn_on_robot : public rclcpp::Node
{
	...
	private:
		...
		void Cmd_Send_Timer_Callback();
		void Send_Cmd_Frame(double linear_x, double linear_y, double angular_z);
    ...
    void Set_LightRgb_Callback(const std_msgs::msg::UInt8MultiArray::SharedPtr msg);
		...
		rclcpp::Time brake_end_time;
		double current_linear_x=0.0;
		double current_linear_y=0.0;
		double current_angular_z=0.0;
		double last_motion_linear_x=0.0;
		double last_motion_linear_y=0.0;
		double last_motion_angular_z=0.0;
		double brake_linear_x=0.0;
		double brake_linear_y=0.0;
		double brake_angular_z=0.0;
		double send_rate_hz=50.0;
		double cmd_timeout_sec=0.25;
		double max_linear_x=0.45;
		double max_linear_y=0.0;
		double max_angular_z=2.4;
		bool brake_enable=true;
		double brake_ratio=1.0;
		double brake_duration_sec=0.5;
		double brake_trigger_threshold=0.02;
		double brake_duration_gain=1.0;
		double brake_min_motion_sec=0.12;
